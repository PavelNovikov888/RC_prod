...
> Для нового продукта выбор будет производится на основе признаков нового товара. В нашем случае мы случайным образом сгенерируем данные признаки из наиболее популярных среди пользователей. Выбор [рекомендаций](https://github.com/PavelNovikov888/RC_prod/blob/master/visual/item_cold.png) товаров связан с наивысшим местом среди других предлагаемых пользователям товаров. В выводе рекомендаций добавится таблица схожести данного продукта с другими.
